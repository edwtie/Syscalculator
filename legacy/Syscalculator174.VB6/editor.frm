...
If Not Mid(usedlast(n), 3) = "" Then
                            ...
                            End If
Next n
If onlyeditor = 0 Then ename = filenod(Form4.Text1) Else ename = filenod(onlyedname)
If onlyedname = ".nod" Then Exit Sub
On Error GoTo 51
Openfiles (ename)
If onlyeditor = 0 Then Edname = Form4.Text1 Else Edname = onlyedname
