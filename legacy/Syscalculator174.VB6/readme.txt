...
what's new in 1.70 beta 1 ?
 
-added 25 converters (nod-files) and subcatergories
-added Open converter
-fixed conversion in comma
-fixed bug in Calculator
-added Syscalculator Editor 
-added File Associations nod
-fixed bug in digit group (for comma's)
-fixed precison values
-added setting decimals
-added autoComplete
-fixed menu in tray
-changed settings for first-time
-changed icons
-added setting decimals
-Changed help-documents



What's new in 1.64 ?
-Changed: Currceny to File
-Fixed: a bug in convertersystem hong.
-Removed: readme.txt
...
-Corrected: wrong version in Setup.
-Changed: Disabled Taskbar 
-Changed: URL in Eng.lng


What’s new in 1.63 ?
-Fixed: icon of tray didn’t display when explorer.exe (part of Windows) has crashed and restart. 
-Fixed: Installation

What’s new in 1.62 rev. B ?
-Added: feature Switch
-Fixed: Some bug in WizardExpress

What’s new in 1.62 rev. A ? 

-Fixed: Some bugs in calculator. 
-Fixed: invalid values if windows is using local setting (English) Thanks for Ton van der Doelen.  

What’s new in 1.62?
-Changed: Readme.txt and Help-documents
-Added: Dutch Help-documents
-Changed: Ned.lng 
-Fixed: Crash in simple Calculator.

What's new in 1.61
-Fixed: Shut-down problems with Syscalculator using Tray
-Added: Startup option


What’s new in 1.6?

-Fixed: bug in WizardExpress concerning the use of ‘Financial’ in cel property. 
-Syscalculator supports negative values now. 
-Improved: simple calculator
-Fixed: some bugs in WizardExpress
-Added: Dutch Pack
-Added: Spanish Pack
-Added: Re-sort feature
-Added: Digit group

Cool features of Syscalculator
