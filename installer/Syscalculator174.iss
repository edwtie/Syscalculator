...
Source: "{#MySourceRoot}\help\*.chm"; DestDir: "{app}\help"; Flags: ignoreversion skipifsourcedoesntexist
Source: "{#MySourceRoot}\help\*"; DestDir: "{app}\help"; Excludes: "*.LOG,*.hhp,*.hhc,*.hhk,*.chm"; Flags: ignoreversion recursesubdirs createallsubdirs skipifsourcedoesntexist
