...
public static class HelpHtml
{
    ...
    private const string NodHelpCssFallback = "body { margin:0; padding:24px 24px 34px; font-family:Segoe UI, Arial, sans-serif; color:#1f2937; background:#ffffff; } h1, h2 { color:#0f3f8f; } pre { background:#101827; color:#e5eefc; padding:12px; border-radius:8px; white-space:pre-wrap; } code { background:#eef4ff; color:#0f3f8f; padding:1px 5px; border-radius:5px; } .notice { background:#fff8e6; border:1px solid #f4d184; border-left:4px solid #d69400; border-radius:8px; padding:10px 12px; margin:10px 0 14px; color:#3f2f12; } .warning-sign { display:flex; align-items:flex-start; gap:12px; background:#fff8e1; border:1px solid #fbbf24; border-left:6px solid #dc2626; border-radius:8px; padding:12px 14px; margin:12px 0 16px; color:#7f1d1d; overflow:hidden; } .warning-sign > svg { flex:0 0 42px; width:42px; height:39px; max-width:42px; max-height:39px; display:block; } .warning-sign > div { flex:1 1 auto; min-width:0; } .warning-sign b { color:#b91c1c; }";
