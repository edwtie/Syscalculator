// Bundled formula help script for packaged help content.
...
window.syscalFormulaHelp.installSearch = function () {
(() => {
...
window.syscalFormulaHelp.installFilm = function () {
    if (!document.getElementById('filmStage')) {
        return;
    }
