    ...
    public static IReadOnlyList<FormulaCard> GetDefaultCards()
    {
        return new[]
        {
            ...
            new FormulaCard(
                ...
                new[] { "VWO B", "VWO D", "Differentiatie" },
                "Quotientregel voor breuken met functies. Vooral handig bij VWO B en verder.",
                """
            ...
            new FormulaCard(
                ...
                "Primitieve van een machtsfunctie. Vooral nuttig voor VWO B, PWS en brug naar propedeuse.",
                """
            ...
            new FormulaCard(
                ...
                new[] { "VWO D", "PWS", "Lineaire algebra", "Limited matrix", "Linear algebra" },
